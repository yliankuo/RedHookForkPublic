...
public class NaiveAiPlayer : Player
{
    ...
    public override void Play(CellGrid cellGrid)
    {
        ...
        old_dim = camera.GetComponent<Dimension>().currentDimension;
        StartCoroutine(Play()); 
    ...
    private IEnumerator Play()
    {
        ...
        {
            camera.GetComponent<Dimension>().setCurrentDimension(((BaseUnit)unit).Dimension);
        ...
        camera.GetComponent<Dimension>().setCurrentDimension(old_dim);
        _cellGrid.EndTurn();     
    }
}